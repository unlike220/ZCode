...
const enUS: Record<string, string> = {
  ...
  "chat.contextUsage.diagnostics.title": "Local diagnostics",
  "chat.contextUsage.diagnostics.preflight": "Local preflight",
  "chat.contextUsage.diagnostics.headroom": "Input headroom",
  "chat.contextUsage.diagnostics.beforeAdmission": "Before admission",
  "chat.contextUsage.diagnostics.toolExposure": "Tool exposure",
  "chat.contextUsage.diagnostics.toolExposureValue": "{exposed} exposed / {eligible} eligible",
  "chat.contextUsage.diagnostics.toolAdmission": "Tool admission",
  "chat.contextUsage.diagnostics.toolAdmissionValue":
    "{admitted}/{candidate} admitted · {omitted} omitted",
  "chat.contextUsage.diagnostics.outputReserve": "Output reserve",
  "chat.contextUsage.diagnostics.safetyMargin": "Safety margin",
  "chat.contextUsage.diagnostics.note":
    "Local preflight values are estimates and may differ from provider-reported usage above.",
