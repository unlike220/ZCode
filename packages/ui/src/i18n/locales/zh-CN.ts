...
const zhCN: Record<string, string> = {
  ...
  "chat.contextUsage.diagnostics.title": "本地诊断",
  "chat.contextUsage.diagnostics.preflight": "本地预检",
  "chat.contextUsage.diagnostics.headroom": "输入余量",
  "chat.contextUsage.diagnostics.beforeAdmission": "准入前",
  "chat.contextUsage.diagnostics.toolExposure": "工具暴露",
  "chat.contextUsage.diagnostics.toolExposureValue": "暴露 {exposed} / 可用 {eligible}",
  "chat.contextUsage.diagnostics.toolAdmission": "工具准入",
  "chat.contextUsage.diagnostics.toolAdmissionValue":
    "准入 {admitted}/{candidate} · 省略 {omitted}",
  "chat.contextUsage.diagnostics.outputReserve": "输出预留",
  "chat.contextUsage.diagnostics.safetyMargin": "安全余量",
  "chat.contextUsage.diagnostics.note": "本地预检为估算值，可能与上方 Provider 实际用量口径不同。",
